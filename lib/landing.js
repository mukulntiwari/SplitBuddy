...
export const TESTIMONIALS = [
  {
    quote:
      "SplitBuddy has made managing my roommate expenses so easy! No more awkward money talks.",
    name: "Chris Evans",
  ...
  {
    quote:
      "SplitBuddy's calculations are so accurate, they're even better than my accountant's!",
    name: "Robert Downey Jr.",
    image: "/testimonials/raju.jpg",
    role: "Philanthropist and Billionaire",
  },
  {
    quote:
      "If that I have SplitBuddy, RDJ can rest easy knowing my expenses are in good hands.",
